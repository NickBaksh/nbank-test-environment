...
public class ResponseSpecs {
    ...
    public static final String TRANSFER_AMOUNT_MIN_ERROR_V_3 = "Invalid accounts or amount";
    ...
    public static final String INSUFFICIENT_FUNDS_ERROR_V2 = "Insufficient funds";
